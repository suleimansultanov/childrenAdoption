...
{
    public class CreateApplication2Controller : Controller
    {
        [HttpGet]
        public ActionResult Index()
        {
            var model = new CreateApp2ViewModel() { ActionNo = 1 };
        ...
        public ActionResult Index(CreateApp2ViewModel model)
        {
            var districts = GetDistrictItems();
            ...
            }, "http://localhost/ServiceConstructor/SoapClient/SendRequest2", "POST", out dynamic response, out string errorMessage))
            {
                if (response.response.passportDataByPSNResponse.response != null)
                {
                    ...
                    model.passportPerson = ((JObject)r).ToObject<CreateApp2ViewModel._passportPerson>();
                }
                else
                {
    ...
    public class _msecData
    {
        ...
        public bool PostoronniyUhod { get; set; }

    }
    public class CreateApp2ViewModel
    {
