...
{
    public class CreateESPOrphanController : Controller
    {
        // GET: CreateESPOrphan
        [HttpGet]
        public ActionResult Index()
        {
            var model = new CreateESPOrphanViewModel() { ActionNo = 1 };
        ...
        public ActionResult Index(CreateESPOrphanViewModel model) 
        {
            var districts = GetDistrictItems();
            ...
            }, "http://localhost/ServiceConstructor/SoapClient/SendRequest2", "POST", out dynamic response, out string errorMessage))
            {
                if (response.response.passportDataByPSNResponse.response != null)
                {
                    ...
                    model.passportPerson = ((JObject)r).ToObject<CreateESPOrphanViewModel._passportPerson>();
                }
                else
                {
    ...
    static List<DistrictItem> GetDistrictItems()
        ...
        public class CreateESPOrphanViewModel
        {
